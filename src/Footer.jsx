...
function Footer() {
  return <footer className="bg-blue-100">
  <div className="container mx-auto px-6">
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 py-12">
      ...
      <div className="flex flex-col gap-4 col-span-2 lg:col-span-1">
        ...
        <p className="text-gray-500 text-sm">Lorem ipsum dolor sit amet, consectetur elit. Consjat tristique eget amet, tempus eu at cttur.</p>
  ...
  <li className="border p-2 rounded-full border-[#00ABAA] duration-300 hover:scale-125 cursor-pointer hover:bg-[#00ABAA] group text-xl">
    ...
    <p className="flex flex-wrap items-center justify-center gap-1 border-t border-gray-300 py-4 text-sm text-gray-500 text-center">
      Designed and Developed By <a href="#" className="text-[#00ABAA]">Themefisher</a> • Distributed by <a href="#" className="text-[#00ABAA]">ThemeWagon</a>
    </p>
  </div>
</footer>
}
